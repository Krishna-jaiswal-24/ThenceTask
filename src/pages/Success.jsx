...
const Success = () => {
	...
	return (
		<>
			...
			<div className="flex items-center justify-center flex-col mx-auto w-[718px] mt-60">
				<div className="mb-10">
				...
				<p className='text-xl text-gray absolute bottom-11'>Redirecting you to Homepage in <span className='text-black font-bold'>{count} Seconds</span></p>
			</div>
